...
# Filename: JuniperDriver5200.py
'''
Individual section on driver (JuniperDriver's (QFX5200-32C) driver)
'''
import re
import ipaddress
...
class JuniperDriver5200(EmSeparateDriver):
    '''
    ...
    def __init__(self):
        ...
        Constructor
        '''
        self.as_super = super(JuniperDriver5200, self)
    ...
    def _set_interface_condition(self,
                                 ...
                                 operation=None):
        '''
        Set information on IO open/close(common to physical and LAG)
        '''
    ...
    def _set_qos_policy_inner_link_device_dependent(self, if_node):
        '''
        Conduct settings on device-dependent section for
        class-of-service node. (internal link/inter-cluster link)
    ...
    def _set_qos_policy_slice_device_dependent(self, if_node):
        '''
        Conduct the settings on device-dependent section of
        class-of-service node. (slice-adding-related)
        '''
        self._set_xml_tag(if_node,
                          "scheduler-map",
                          None,
    ...
    def _get_replace_internal_link_from_ec(self,
        ...
        '''
        Obtain the information of EC message/DB regarding Internal Link for deletion
        '''
        inner_ifs = []
    ...
    def _get_internal_if_replace_info(self,
                                      ...
                                      db_info=None):
        '''
        Obtain the Internal Link Information from EC message(Regardless of physical or LAG)
        '''
        internal_link_db = self._get_internal_link_db(
            db_info, if_info.get("name"))
    ...
    def _get_if_condition_from_ec(self,
                                  ...
                                  db_info=None):
        '''
        Obtain EC message and DB information related to IP open/close.
        '''
    ...
    def _get_qos_l3_vlan_if_info_from_ec(self,
        ...
        for tmp_cp in db_info.get("cp"):
            if if_name == tmp_cp["if_name"] and \
                    ec_cp.get("vlan-id") == tmp_cp["vlan"].get("vlan_id"):
                target_cp = tmp_cp
                break
    ...
    def _set_qos_l3_vlan_unit_address(self,
                                      ...
                                      **params):
        '''
        Set inet on the family node (IPv4,IPv6 common)
    ...
    def _check_replace_kind(self, device_mes):
        '''
        Judge whether internal link change depends on cost value change or Lag speed change.
        Parameter:
