...
| 26.      |         |         |         | EmCLIProtocol.py | Protocol Processing (CLI) Module for Devices | \-      |
...
| 51.      |         |         |         | EmL2SliceUpdate.py | L2 Slice Update Scenario      | \-      |
| 52.      |         |         |         | EmL3SliceDelete.py | L3 Slice Deletion Scenario      | \-      |
| 53.      |         |         |         | EmL3SliceGet.py | L3 Slice Information Adjustment Scenario      | \-      |
| 54.      |         |         |         | EmL3SliceMerge.py | L3 Slice Addition Scenario      | \-      |
| 55.      |         |         |         | EmL3SliceUpdate.py | L3 Slice Update Scenario      | \-      |
| 56.      |         |         |         | EmLeafDelete.py | Leaf Deletion Scenario    | \-      |
| 57.      |         |         |         | EmLeafMerge.py | Leaf Addition Scenario    | \-      |
| 58.      |         |         |         | EmMergeScenario.py | Resource Addition Scenario Module | \-      |
| 59.      |         |         |         | EmRecover.py | Recover Node Scenario | \-      |
| 60.      |         |         |         | EmRecoverNode.py | Recover Node Scenario | \-      |
| 61.      |         |         |         | EmRecoverService.py | Recover Node Scenario | \-      |
| 62.      |         |         |         | EmSpineDelete.py | Spine Deletion Scenario   | \-      |
| 63.      |         |         |         | EmSpineMerge.py | Spine Addition Scenario   | \-      |
| 64.      |         |         |         | EmSeparateScenario.py | Individual Scenario Module | \-      |
| 65.      |         |         |         | \__init__.py | Initialization Module | \-      |
| 66.      |         |         | SeparateDriver | CiscoDriver.py | Cisco (5001, 5011) Driver Module       | \-      |
| 67.      |         |         |         | CiscoDriver5501.py | Cisco 5501 Driver Module       | \-      |
| 68.      |         |         |         | EmRecoverUtil.py | Recover Node Utility       | \-      |
| 69.      |         |         |         | JuniperDriver5100.py | Juniper 5100 Driver Module       | \-      |
| 70.      |         |         |         | JuniperDriver5200.py | Juniper 5200 Driver Module       | \-      |
| 71.      |         |         |         | JuniperDriverMX240.py | J Company Core Router Driver Module       | \-      |
| 72.      |         |         |         | OcNOSDriver.py | OcNOS Driver Module   | \-      |
| 73.      |         |         |         | EmSeparateDriver.py | Driver Individual Module  | \-      |
| 74.      |         |         |         | \__init__.py | Initialization Module | \-      |
| 75.      |         |         | SystemUtility | EmSysCommonUtilityDB.py | System Common (DB) Utility Module  | \-      |
| 76.      |         |         |         | \__init__.py | Initialization Module | \-      |
| 77.      |         | conf    |         | conf_driver.conf | Driver Individual Part Operational Configuration File  | \-      |
| 78.      |         |         |         | conf_if_process.conf | I/F Process Part Operational Configuration File     | \-      |
| 79.      |         |         |         | conf_scenario.conf | Scenario Individual Part Operational Configuration File | \-      |
| 80.      |         |         |         | conf_sys_common.conf | EM Common Configuration File      | \-      |
| 81.      |         |         |         | conf_separate_driver_cisco.conf | Cisco Driver Operation Configuration File       | \-      |
| 82.      |         |         |         | conf_if_process_rest.conf | REST Server Operation Configuration FileT    | \-      |
| 83.      |         |         |         | conf_scenario_rest.conf | REST Scenario Individual Part Operation Configuration File    | \-      |
| 84.      |         |         |         | Cisco.conf | QoS of Cisco Driver Operation Configuration File    | \-      |
| 85.      |         |         |         | Juniper.conf | QoS of Juniper Driver Operation Configuration File    | \-      |
| 86.      |         |         |         | OcNOS.conf | QoS of OcNOS Driver Operation Configuration File    | \-      |
| 87.      |         | installer | \-      | \-      | \-      | \-      |
| 88.      |         |         |         | whl_package.tar | In-use Python Library Package  | In-Advance DL |
| 89.      |         |         |         | pip-8.1.2.tar.gz | PIP Command for Python Library Install     | In-Advance DL |
| 90.      |         |         |         | setuptools-28.6.0.tar.gz | pip Dependent Package     | In-Advance DL |
| 91.      |         |         | dhcp.v4.2.5 | dhcp-4.2.5-42.el7.centos.x86_64.rpm | DHCP Installation Package    | In-Advance DL |
| 92.      |         |         | ntp.v4.2 | autogen-libopts-5.18-5.el7.x86_64.rpm | NTP Installation Package     | In-Advance DL |
| 93.      |         |         |         | ntpdate-4.2.6p5-22.el7.centos.x86_64.rpm | NTP Installation Package     | In-Advance DL |
| 94.      |         |         |         | ntp-4.2.6p5-22.el7.centos.x86_64.rpm | NTP Installation Package     | In-Advance DL |
| 95.      |         |         | postgresql.v9.3.13 | postgresql93-9.3.13-1PGDG.rhel7.x86_64.rpm | PostgreSQL Installation Package | In-Advance DL |
| 96.      |         |         |         | postgresql93-contrib-9.3.13-1PGDG.rhel7.x86_64.rpm | PostgreSQL Installation Package | In-Advance DL |
| 97.      |         |         |         | postgresql93-devel-9.3.13-1PGDG.rhel7.x86_64.rpm | PostgreSQL Installation Package | In-Advance DL |
| 98.      |         |         |         | postgresql93-libs-9.3.13-1PGDG.rhel7.x86_64.rpm | PostgreSQL Installation Package | In-Advance DL |
| 99.      |         |         |         | postgresql93-server-9.3.13-1PGDG.rhel7.x86_64.rpm | PostgreSQL Installation Package | In-Advance DL |
| 100.      |         |         |         | uuid-1.6.2-26.el7.x86_64.rpm | PostgreSQL Dependent Package | In-Advance DL |
| 101.      |         |         |         | libxslt-1.1.28-5.el7.x86_64.rpm | PostgreSQL Dependent Package | In-Advance DL |
| 102.      |         |         | pacemaker.v1.1.14-1.1 | pacemaker-1.1.14-1.el7.x86_64.rpm | Pacemaker Installation Package | In-Advance DL |
| 103.      |         |         |         | corosync-2.3.5-1.el7.x86_64.rpm | Corosync Installation Package | In-Advance DL |
| 104.      |         |         |         | crmsh-2.1.5-1.el7.x86_64.rpm | crm Command Installation Package     | In-Advance DL |
| 105.      |         |         |         | cluster-glue-1.0.12-2.el7.x86_64.rpm | Pacemaker Dependent Package | In-Advance DL |
| 106.      |         |         |         | cluster-glue-libs-1.0.12-2.el7.x86_64.rpm | Pacemaker Dependent Package | In-Advance DL |
| 107.      |         |         |         | corosynclib-2.3.5-1.el7.x86_64.rpm | Corosync Dependent Package | In-Advance DL |
| 108.      |         |         |         | ipmitool-1.8.13-9.el7_2.x86_64.rpm | Pacemaker Dependent Package | In-Advance DL |
| 109.      |         |         |         | libqb-1.0-1.el7.x86_64.rpm | Pacemaker Dependent Package | In-Advance DL |
| 110.      |         |         |         | libtool-ltdl-2.4.2-21.el7_2.x86_64.rpm | Pacemaker Dependent Package | In-Advance DL |
| 111.      |         |         |         | libxslt-1.1.28-5.el7.x86_64.rpm | Pacemaker Dependent Package | In-Advance DL |
| 112.      |         |         |         | libyaml-0.1.4-11.el7_0.x86_64.rpm | Pacemaker Dependent Package | In-Advance DL |
| 113.      |         |         |         | lm_sensors-libs-3.3.4-11.el7.x86_64.rpm | Pacemaker Dependent Package | In-Advance DL |
| 114.      |         |         |         | nano-2.3.1-10.el7.x86_64.rpm | crm Dependent Package     | In-Advance DL |
| 115.      |         |         |         | net-snmp-agent-libs-5.7.2-24.el7_2.1.x86_64.rpm | Corosync Dependent Package | In-Advance DL |
| 116.      |         |         |         | net-snmp-libs-5.7.2-24.el7_2.1.x86_64.rpm | Corosync Dependent Package | In-Advance DL |
| 117.      |         |         |         | openhpi-libs-3.4.0-2.el7.x86_64.rpm | Pacemaker Dependent Package | In-Advance DL |
| 118.      |         |         |         | OpenIPMI-libs-2.0.19-11.el7.x86_64.rpm | Pacemaker Dependent Package | In-Advance DL |
| 119.      |         |         |         | OpenIPMI-modalias-2.0.19-11.el7.x86_64.rpm | Pacemaker Dependent Package | In-Advance DL |
| 120.      |         |         |         | pacemaker-cli-1.1.14-1.el7.x86_64.rpm | Pacemaker Dependent Package | In-Advance DL |
| 121.      |         |         |         | pacemaker-cluster-libs-1.1.14-1.el7.x86_64.rpm | Pacemaker Dependent Package | In-Advance DL |
| 122.      |         |         |         | pacemaker-libs-1.1.14-1.el7.x86_64.rpm | Pacemaker Dependent Package | In-Advance DL |
| 123.      |         |         |         | pacemaker-all-1.1.14-1.1.el7.noarch.rpm | Pacemaker Dependent Package | In-Advance DL |
| 124.      |         |         |         | perl-5.16.3-286.el7.x86_64.rpm | Pacemaker Dependent Package | In-Advance DL |
| 125.      |         |         |         | perl-Carp-1.26-244.el7.noarch.rpm | Pacemaker Dependent Package | In-Advance DL |
| 126.      |         |         |         | perl-constant-1.27-2.el7.noarch.rpm | Pacemaker Dependent Package | In-Advance DL |
| 127.      |         |         |         | perl-Encode-2.51-7.el7.x86_64.rpm | Pacemaker Dependent Package | In-Advance DL |
| 128.      |         |         |         | perl-Exporter-5.68-3.el7.noarch.rpm | Pacemaker Dependent Package | In-Advance DL |
| 129.      |         |         |         | perl-File-Path-2.09-2.el7.noarch.rpm | Pacemaker Dependent Package | In-Advance DL |
| 130.      |         |         |         | perl-File-Temp-0.23.01-3.el7.noarch.rpm | Pacemaker Dependent Package | In-Advance DL |
| 131.      |         |         |         | perl-Filter-1.49-3.el7.x86_64.rpm | Pacemaker Dependent Package | In-Advance DL |
| 132.      |         |         |         | perl-Getopt-Long-2.40-2.el7.noarch.rpm | Pacemaker Dependent Package | In-Advance DL |
| 133.      |         |         |         | perl-HTTP-Tiny-0.033-3.el7.noarch.rpm | Pacemaker Dependent Package | In-Advance DL |
| 134.      |         |         |         | perl-libs-5.16.3-286.el7.x86_64.rpm | Pacemaker Dependent Package | In-Advance DL |
| 135.      |         |         |         | perl-macros-5.16.3-286.el7.x86_64.rpm | Pacemaker Dependent Package | In-Advance DL |
| 136.      |         |         |         | perl-parent-0.225-244.el7.noarch.rpm | Pacemaker Dependent Package | In-Advance DL |
| 137.      |         |         |         | perl-PathTools-3.40-5.el7.x86_64.rpm | Pacemaker Dependent Package | In-Advance DL |
| 138.      |         |         |         | perl-Pod-Escapes-1.04-286.el7.noarch.rpm | Pacemaker Dependent Package | In-Advance DL |
| 139.      |         |         |         | perl-podlators-2.5.1-3.el7.noarch.rpm | Pacemaker Dependent Package | In-Advance DL |
| 140.      |         |         |         | perl-Pod-Perldoc-3.20-4.el7.noarch.rpm | Pacemaker Dependent Package | In-Advance DL |
| 141.      |         |         |         | perl-Pod-Simple-3.28-4.el7.noarch.rpm | Pacemaker Dependent Package | In-Advance DL |
| 142.      |         |         |         | perl-Pod-Usage-1.63-3.el7.noarch.rpm | Pacemaker Dependent Package | In-Advance DL |
| 143.      |         |         |         | perl-Scalar-List-Utils-1.27-248.el7.x86_64.rpm | Pacemaker Dependent Package | In-Advance DL |
| 144.      |         |         |         | perl-Socket-2.010-3.el7.x86_64.rpm | Pacemaker Dependent Package | In-Advance DL |
| 145.      |         |         |         | perl-Storable-2.45-3.el7.x86_64.rpm | Pacemaker Dependent Package | In-Advance DL |
| 146.      |         |         |         | perl-Text-ParseWords-3.29-4.el7.noarch.rpm | Pacemaker Dependent Package | In-Advance DL |
| 147.      |         |         |         | perl-threads-1.87-4.el7.x86_64.rpm | Pacemaker Dependent Package | In-Advance DL |
| 148.      |         |         |         | perl-threads-shared-1.43-6.el7.x86_64.rpm | Pacemaker Dependent Package | In-Advance DL |
| 149.      |         |         |         | perl-TimeDate-2.30-2.el7.noarch.rpm | Pacemaker Dependent Package | In-Advance DL |
| 150.      |         |         |         | perl-Time-HiRes-1.9725-3.el7.x86_64.rpm | Pacemaker Dependent Package | In-Advance DL |
| 151.      |         |         |         | perl-Time-Local-1.2300-2.el7.noarch.rpm | Pacemaker Dependent Package | In-Advance DL |
| 152.      |         |         |         | pm_crmgen-2.1-1.el7.noarch.rpm | Pacemaker Dependent Package | In-Advance DL |
| 153.      |         |         |         | pm_diskd-2.2-1.el7.x86_64.rpm | Diskd RA Package   | In-Advance DL |
| 154.      |         |         |         | pm_extras-2.2-1.el7.x86_64.rpm | VIPCheck RA Package | In-Advance DL |
| 155.      |         |         |         | pm_logconv-cs-2.2-1.el7.noarch.rpm | Pacemaker Dependent Package | In-Advance DL |
| 156.      |         |         |         | psmisc-22.20-9.el7.x86_64.rpm | Pacemaker Dependent Package | In-Advance DL |
| 157.      |         |         |         | pssh-2.3.1-5.el7.noarch.rpm | crm Dependent Package     | In-Advance DL |
| 158.      |         |         |         | python-dateutil-1.5-7.el7.noarch.rpm | Pacemaker Dependent Package | In-Advance DL |
| 159.      |         |         |         | python-lxml-3.2.1-4.el7.x86_64.rpm | Pacemaker Dependent Package | In-Advance DL |
| 160.      |         |         |         | resource-agents-3.9.7-1.2.6f56.el7.x86_64.rpm | Standard RA Package Incl. Virtual IPRA | In-Advance DL |
| 161.      |         |         |         | pacemaker_install.sh | Package Installer | In-Advance DL |
| 162.      |         |         | sysstat-11.6.0-1 | sysstat-11.6.0-1.x86_64.rpm | Sysstat Installation Package | In-Advance DL |
| 163.      |         |         | flask-0.12.2 | Flask-0.12.2-py2.py3-none-any.whl | Flask Installation Package   | In-Advance DL |
| 164.      |         |         |         | click-6.7-py2.py3-none-any.whl | Flask Dependent Package   | In-Advance DL |
| 165.      |         |         |         | itsdangerous-0.24.tar.gz | Flask Dependent Package   | In-Advance DL |
| 166.      |         |         |         | Jinja2-2.9.6-py2.py3-none-any.whl | Flask Dependent Package   | In-Advance DL |
| 167.      |         |         |         | MarkupSafe-1.0.tar.gz | Flask Dependent Package   | In-Advance DL |
| 168.      |         |         |         | Werkzeug-0.12.2-py2.py3-none-any.whl | Flask Dependent Package   | In-Advance DL |
| 169.      |         | script  | \-        | \-      | \-      | \-      |
| 170.      |         |         |         | ra_config.xlsx | Resource Agent Configuration File | \-      |
| 171.      |         |         |         | create_table.sql | Table Creation Script   | \-      |
| 172.      |         |         |         | drop_table.sql | Table Deletion Script   | \-      |
...
#### 3.1.1.5. Permit the Connection of NTP
...
> Execute the following command to create corosync.conf for running
> pacemaker.
>
...
In the case of installing some EM controller in one server,
locate in the path of each EM contoller that specified by the user.
(For example, like /opt/em1, /opt/em2.)
...
**\[cp -r \~/setup/em/lib/\* \$EM\_HOME/lib/\] \[Enter\]**
...
**\[cp -r \~/setup/em/conf/\* \$EM\_HOME/conf/\]
\[Enter\]**
...
**\[cp -r \~/setup/em/bin/\* \$EM\_HOME/bin/\] \[Enter\]**
...
In the case of installing some EM controller in one server,
make the schema the number of EM contoller installed.
(For example, like msf_em1, msf_em2.)
...
one EM controller on the same server.
...
**\[vi \$EM\_HOME/bin/em\] \[Enter\]**

```
...
EM_CONTROL_SHELL_PATH="$EM_HOME/bin/em_ctl.sh"
...
```
