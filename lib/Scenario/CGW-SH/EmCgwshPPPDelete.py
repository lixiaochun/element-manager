...
# Filename: EmCgwshPPPDelete.py

'''
Individual scenario for deleting PPP in Cgwsh service
'''
import json
...
class EmCgwshPPPDelete(EmCgwshServiceFlavor, EmCgwshServiceBase):
    '''
    Class for deleting PPP in Cgwsh service
    '''
    ...
    def __init__(self):
        ...
        Costructor
        '''
        super(EmCgwshPPPDelete, self).__init__()
        ...
        self._scenario_name = "CgwshPPPDelete"
