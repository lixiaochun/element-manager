...
# Filename: EmRecoverUtilBLeaf.py
'''
Utility for restoration(B-Leaf expansion)
'''
...
class EmRecoverUtilBLeaf(EmRecoverUtilBase.EmRecoverUtilBase):
    '''
    ...
    def __init__(self):
        ...
        super(EmRecoverUtilBLeaf, self).__init__()

    @decorater_log
    def _create_recover_ec_message(self, ec_message, db_info):
        '''
       Create B-Leaf creation EC message for restoration
        Parameter:
